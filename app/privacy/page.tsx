...
export const metadata = {
  title: "Privacy Policy | QuoteYeti",
  description: "QuoteYeti privacy policy explaining how we collect, use, and protect your information.",
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-card rounded-xl shadow-lg p-8 md:p-12">
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-foreground mb-4">Google Analytics</h2>
                <p className="text-muted-foreground mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-foreground mb-4">Facebook</h2>
                <p className="text-muted-foreground mb-4">
                  As advertisers on Facebook and through our Facebook page, we, (not Facebook) may collect content or information from a Facebook user and such information may be used in the same manner specified in this Privacy Policy. You consent to our collection of such information. We abide by Facebook&apos;s Data Use Restrictions. Any ad data collected, received or derived from our Facebook ad (&quot;Facebook advertising data&quot;) is only shared with someone acting on our behalf, such as our service provider. We are responsible for ensuring that our service providers protect any Facebook advertising data or any other information obtained from us, limit our use of all of that information, and keep it confidential and secure.
                </p>
                <p className="text-muted-foreground mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-foreground mb-4">How do we store your information?</h2>
                <p className="text-muted-foreground mb-4">
                  Your information is stored at the list server that delivers the Site content and messaging. Your information can only be accessed by those who help manage those lists in order to deliver e-mail to those who would like to receive the Site material. All of the messaging or emails that are sent to you by the Site include an unsubscribe link in them. You can remove yourself at any time from our mailing list by clicking on the unsubscribe link that can be found in every communication that we send you.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  This policy may be changed at any time at our discretion. If we should update this policy, we will post the updates to this page on our Website. If you have any questions or concerns regarding our privacy policy please direct them to: wes@insuranceyeti.com
                </p>
              </section>
            </div>
          </div>
